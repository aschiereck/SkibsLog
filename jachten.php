...
<section class="content-page">
    <div class="page-header">
        ...
        <a href="jachten.php?actie=nieuw" class="action-button-header"><i class="fa-solid fa-plus"></i> Nieuw Jacht
            Toevoegen</a>
    </div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                <?php if ($result_jachten && $result_jachten->num_rows > 0): ?>
                    <?php while ($jacht = $result_jachten->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><span
                                    class="status-<?php echo strtolower(str_replace(' ', '-', $jacht['Status'])); ?>"><?php echo htmlspecialchars($jacht['Status']); ?></span>
                            </td>
                            <td>€ <?php echo number_format($jacht['Vraagprijs'], 2, ',', '.'); ?></td>
                            <td><?php echo htmlspecialchars($jacht['Ligplaats']); ?></td>
                            <td class="actions">
                                <a href="jacht_detail.php?id=<?php echo $jacht['SchipID']; ?>" title="Bekijken"><i
                                        class="fa-solid fa-eye"></i></a>
                                <a href="jacht_form.php?id=<?php echo $jacht['SchipID']; ?>" title="Wijzigen"><i
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="8">Geen motorjachten gevonden.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
